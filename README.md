...
- ✅ **Complete API Coverage** - All Bale Bot API methods implemented
- ✅ **Strongly Typed** - Full IntelliSense and compile-time checking
- ✅ **Async/Await** - Non-blocking operations throughout
- ✅ **Dependency Injection** - Seamless integration with ASP.NET Core
- ✅ **Automatic Retry** - Built-in rate limit handling with auto-retry
...
## 📦 Installation
```bash
dotnet add package HexaBale
```

### Package Manager

```bash
Install-Package HexaBale
```